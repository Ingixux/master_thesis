...
trafficpatternStart=[2024,2,19]
trafficpatternEnd=[2024,2,21]

traningDaysStart=[2024,2,19]
traningDaysEnd=[2024,2,21]

detectDaysStart=[2024,2,26]
detectDaysEnd=[2024,2,28]
